...
LineVsPlane()
{
 ...
 TEST_DESCRIPTION("Plane -Y, Line at(0,-10,0), Dir (0,1,0), Length 5")
 {
  beastie::Plane plane = beastie::Plane(Ogre::Vector3::NEGATIVE_UNIT_Y, 0);
  beastie::Line  line = beastie::Line(Ogre::Vector3(0, -10, 0), Ogre::Vector3::UNIT_Y, 5);
 ...
 {
  beastie::Plane plane = beastie::Plane(Ogre::Vector3::NEGATIVE_UNIT_Y, 0);
  beastie::Line  line = beastie::Line(Ogre::Vector3(0, -10, 0), Ogre::Vector3::UNIT_Y, 10);
